...
const toastVariants = cva(
  'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-lg border border-white/10 bg-surface p-4 shadow-lg transition-all',
  {
    variants: {
      variant: {
        default: 'text-foreground',
        destructive: 'border-coral/50 text-coral',
      },
    },
